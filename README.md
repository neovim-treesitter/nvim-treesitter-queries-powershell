# nvim-treesitter-queries-powershell

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-powershell/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-powershell/actions/workflows/validate.yml)

Neovim tree-sitter queries for **powershell**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-powershell",
...
- [ ] Changes are scoped to `powershell` — do not include files for other languages
